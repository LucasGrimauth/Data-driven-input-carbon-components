...
import ListBox, { PropTypes as ListBoxPropTypes } from "carbon-components-react/es/components/ListBox";
...
export default class MultiSelectComboBox extends React.Component {
  ...
  render() {
    ...
    const selectedItems = propsSelectedItems ? propsSelectedItems : stateSelectedItems; // externally controlled if selectedItems props exist
